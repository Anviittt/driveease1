...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        form.addEventListener('submit', function (event) {
            ...
            var vehicleCheckboxes = document.querySelectorAll('input[name="vehicles[]"]');
            var licenceCheckboxes = document.querySelectorAll('input[name="licence[]"]');
            var experienceInput = document.getElementById('expe_year');
            ...
            if (phoneInput.value.length !== 10 || isNaN(phoneInput.value)) {
                displayError('Mobile number should be a 10-digit number.', phoneInput);
                event.preventDefault(); // Prevent form submission
            }
...
if (!passwordRegex.test(passwordInput.value)) {
    displayError('Password must contain at least one number, one uppercase and lowercase letter, and be at least 8 characters long.', passwordInput);
    event.preventDefault(); // Prevent form submission
}


            // Validate at least one vehicle checkbox is selected
            if (!atLeastOneCheckboxSelected(vehicleCheckboxes)) {
                displayCheckboxError('Please select at least one vehicle.', vehicleCheckboxes[0]); // Display error below the first vehicle checkbox
                event.preventDefault(); // Prevent form submission
            }

            // Validate at least one licence checkbox is selected
            if (!atLeastOneCheckboxSelected(licenceCheckboxes)) {
                displayCheckboxError('Please select at least one licence type.', licenceCheckboxes[0]); // Display error below the first licence checkbox
                event.preventDefault(); // Prevent form submission
            }
...
// Check if the input is empty, not a number, or less than 1 (natural numbers start from 1)
if (experienceValue === '' || isNaN(experienceValue) || !Number.isInteger(Number(experienceValue)) || Number(experienceValue) <= 0) {
    displayError('Enter a valid natural number (1 or higher) for years of experience.', experienceInput);
    event.preventDefault(); // Prevent form submission
}
        ...
        function atLeastOneCheckboxSelected(checkboxes) {
...
<body>
    <header>
     ...
     <main>
      ...
      <form method="post" action="instructor_signup_script.php">
        <div class="container">
          <div class="row">
            <div class="col">
          ...
          <div class="row">
            ...
            <div class="col-sm">
              ...
              <input type="password" class="form-control" id="password" name="password" placeholder="Set Password" Set Password"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
            </div>
          </div>
          <div class="row pt-4">
            <p>
              Have Learning Licence and experience of:
            </p>
          </div>
          <div class="row">
            <div class="col">
            ...
            <div class="row">
              <div class="col">
                <div class="form-check form-check-inline">
                  <input class="form-check-input" name="licence[]" type="checkbox" id="inlineCheckbox1" value="National">
                  <label class="form-check-label" for="inlineCheckbox1">National</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" name="licence[]" type="checkbox" id="inlineCheckbox2" value="International">
            ...
            <div class="row py-4">
              ...
              <input type="number" class="form-control form2" id="expe_year" name="experience" placeholder="eg: 4">
            </div>
            <div class="row">
    ...
    <footer>
      <div class="container-fluid bg-dark text-light footer mt-3 my-6 mb-0 py-6">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-warning mb-4">Get In Touch</h4>
                    <h2 class="text-primary mb-4"><i class="fa fa-car text-warning me-2"></i>Drivin</h2>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link text-warning" href="">Our Services</a>
                    <a class="btn btn-link text-warning" href="">Terms & Condition</a>
                    <a class="btn btn-link text-warning" href="">Support</a>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-warning mb-4">Popular Links</h4>
                    <a class="btn btn-link text-warning" href="">About Us</a>
                    <a class="btn btn-link text-warning" href="">Contact Us</a>
                    <a class="btn btn-link text-warning" href="">Our Services</a>
                    <a class="btn btn-link text-warning" href="">Terms & Condition</a>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <h6 class="text-warning mt-4 mb-3">Follow Us</h6>
    ...
    <!-- Copyright Start -->
    <div class="container-fluid copyright text-light py-4 bg-black">
                <div class="col-md-6 text-center text-warning mb-3 mb-md-0">
